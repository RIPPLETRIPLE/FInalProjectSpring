...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (!roleAccess.equals(userRole) && !httpRequest.getRequestURI().equals("") && !httpRequest.getRequestURI().contains(AUTH_ERROR)) {
            httpRequest.getRequestDispatcher(AUTH_ERROR).forward(httpRequest, httpResponse);
            return;
        }
